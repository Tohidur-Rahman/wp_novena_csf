...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'novena' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		elseif ( is_search() ) :
			...
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'novena' ); ?></p>
			<?php
			get_search_form();
